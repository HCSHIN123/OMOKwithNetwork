...
const uint32_t TableStruct_struct_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::Room, _impl_.roomnumber_),
  PROTOBUF_FIELD_OFFSET(::Protocol::Room, _impl_.count_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::Protocol::Player)},
  { 7, -1, -1, sizeof(::Protocol::Room)},
};
...
Room::Room(const Room& from)
  ...
  ::memcpy(&_impl_.roomnumber_, &from._impl_.roomnumber_,
    ...
    reinterpret_cast<char*>(&_impl_.roomnumber_)) + sizeof(_impl_.count_));
...
uint8_t* Room::_InternalSerialize(
  ...
  if (this->_internal_roomnumber() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(1, this->_internal_roomnumber(), target);
  }
...
void Room::InternalSwap(Room* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Room, _impl_.count_)
      + sizeof(Room::_impl_.count_)
      - PROTOBUF_FIELD_OFFSET(Room, _impl_.roomnumber_)>(
